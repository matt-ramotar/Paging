...
class ConcurrentNormalizedStoreV2<Id : Comparable<Id>, Q : Quantifiable<Id>, K : Any, V : Identifiable<Id, Q>, E : Any>(
    ...
    private val selfUpdatingItemPresenter: SelfUpdatingItemPresenterV2<Id, Q, K, V, E>,
