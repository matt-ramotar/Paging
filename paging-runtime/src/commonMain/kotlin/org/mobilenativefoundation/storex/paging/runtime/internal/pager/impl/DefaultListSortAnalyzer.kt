...
/**
 * Thread-safe implementation of [ListSortAnalyzer] optimized for small to medium-sized lists of [Id]s.
 *
 ...
 */
class DefaultListSortAnalyzer<Id : Identifier<Id>>(
    ...
    private val cache = atomic(listOf<CacheEntry<Id>>())
     ...
     */
    private fun updateCache(ids: List<Id?>, order: Order) {
